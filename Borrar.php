...
if(!$mysqli){
    ...
    $numero = $_GET["number"];
    $result = mysqli_query($mysqli, 'SELECT numero_pokedex,nombre, "Previo" FROM pokemon where numero_pokedex = '.$numero.'');
...
$result = mysqli_query($mysqli, 'DELETE FROM  pokemon where numero_pokedex = '.$numero.'');
